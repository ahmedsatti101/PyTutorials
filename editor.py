...
class Mp3Panel(wx.Panel):
    ...
    def update_mp3_listing(self, folder_path):
        ...
        for mp3 in mp3s:
            ...
            self.list_ctrl.InsertItem(index, 1, mp3_object.tag.album)
            self.list_ctrl.InsertItem(index, 2, mp3_object.tag.title)
...
class Mp3Frame(wx.Frame):
    ...
    def on_open_folder(self, event):
        ...
        dlg = wx.DirDialog(self, title, style=wx.DIRP_DEFAULT_STYLE)
